    ...
    <div class="tagset">
        <ul>
            <li v-for="tag in tags">
                <a @click="update($index, tag.tagName, tag.objectId)" :class="{'tagset-active': $index === selected}">
            {{tag.tagName}}
          </a>
            </li>
        </ul>
...
import {
    updateHeadline, getAvaliableTags, getPostsByTag
}
from '../vuex/actions'
import {
    tags
...
export default {
    ...
    vuex: {
        ...
        actions: {
            ...
            getTags: getAvaliableTags,
            getTagContentList: getPostsByTag
        }
    },
    created() {
        this.getTags()
